    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     try {
        ...
        datecommentaire.setCellValueFactory(new PropertyValueFactory<>("datecommentaire"));
                    ...
                    cell = new TableCell<Commentaire, String>() {
                        ...
                        public void updateItem(String item, boolean empty) {
                            ...
                            if (empty) {
                                ...
                                FontAwesomeIconView editIcon = new FontAwesomeIconView(FontAwesomeIcon.COMMENT);
                          ...
                          /* try {
                                ...
                                ModifierController modifierRubriqueController = loader.getController();
         ...
         Logger.getLogger(CommentaireadminController.class.getName()).log(Level.SEVERE, null, ex);
     }
